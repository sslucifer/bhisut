...
import WebViewExample from './privacy_policy.js'
  ...
  render () {
   return (
    <View style={{flex:1}}>
          ...
          <Image source={require('./assets/fire.jpg')}
                  style={styles.image}/>
          ...
          <View style={styles.container}>
              ...
              <Input 
                ...
                autoCapitalize = "none"
                rightIcon={<Icon name='mobile-alt' 
                                  size={18} 
                                  color='black'/>}/>
              ...
              <Input 
                ...
                autoCapitalize = "none"
                rightIcon={<Icon name={this.state.icon} 
                                onPress={() => this.change()} 
                                size={18} 
                                solid
                                color='black'/>}/>
              ...
              <View style={styles.containR}>
                ...
                <View style={styles.containC}>
                    <SocialIcon button style={{paddingHorizontal:10,
                                              borderRadius:5,
                                              elevation:10,
                                              margin:10}} 
                ...
                <View style={{flexDirection:"column",
                    ...
                    <CheckBox title='I agree to Privacy Policy.' 
                  ...
                  <View style={{flexDirection:"row",marginTop:10}}>
                    ...
                    <Text style={{fontSize:18,
                                  color:"black"}}>  to see Privacy Policy.</Text>
